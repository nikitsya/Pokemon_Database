INSERT INTO Region (region_id, name, climate)
VALUES (1, "Kanto", "Humid subtropical climate"),
...
INSERT INTO Town (town_id, region_id, name, population)
VALUES (1, 1, "Pewter City", 30),
...
INSERT INTO Trainer (trainer_id, home_town_id, name, gender, age)
VALUES (1, 1, "Brock", "M", 15),
       (2, 2, "Misty", "F", 10),
       (3, 3, "Surge", "M", 34),
       (4, 4, "Josh", "M", 12),
       (5, 5, "Jane", "F", 75),
...
INSERT INTO Pokemon (pokemon_id, name, base_hp, base_attack, base_defense)
VALUES (1, "Bulbasaur", 45, 49, 49),
       (2, "Ivysaur", 60, 62, 63),
       (3, "Venusaur", 80, 82, 83),
...
INSERT INTO TrainerPokemon (caught_id, trainer_id, pokemon_id, nick_name, pokemon_level, hit_points_iv, attack_iv,
                            defense_iv)
VALUES (1, 1, 74, "Geodude", 12, 10, 10, 10),
...
VALUES (1, "Boulder Badge"),
       (2, "Water Badge"),
       (3, "Normal Badge");

INSERT INTO Gym (gym_id, leader_id, town_id, type_id, badge_id)
VALUES (1, 1, 1, 11, 1),
       (2, 2, 2, 4, 2),
       (3, 3, 3, 8, 3);

INSERT INTO TypeAdvantage (type_1, type_2, type_advantage)
VALUES (1, 1, "Normal"),
       (1, 2, "Normal"),
       (1, 3, "Normal"),
       (1, 4, "Normal"),
...
INSERT INTO WildPokemon (wild_id, pokemon_id, region_id, location_description, min_level, max_level)
VALUES (1, 1, 7, "Lush Jungle", 18, 22),
